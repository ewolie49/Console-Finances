...
// Title of the exercise below. I

//I initially tried to print the title using the following commented code below, however, looking at the original it looks like it is on a separate line
...
for(var i=1; i < TotalMonths; i++)
{
  var CurrentMonth = finances [i][1];
  var PreviousMonth = finances [i - 1][1];
  var MonthlyIncrease = CurrentMonth - PreviousMonth;
...
for (var i = 1; i < TotalMonths; i++) {
  var CurrentMonth = finances[i][1];
  var PreviousMonth = finances[i - 1][1];
  var MonthlyDecrease = PreviousMonth - CurrentMonth;
